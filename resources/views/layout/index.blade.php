        ...
        <div class="quixnav">
            <div class="quixnav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    <li><a href="{{ route('home') }}" aria-expanded="false"><i class="icon icon-globe-2"></i><span
                                class="nav-text">Home</span></a></li>
                    <li><a href="{{ route('unit.index') }}" aria-expanded="false"><i class="icon icon-globe-2"></i><span
                                class="nav-text">Unit</span></a></li>
                    <li><a href="{{ route('golongan.index') }}" aria-expanded="false"><i class="icon icon-globe-2"></i><span
                                class="nav-text">Golongan</span></a></li>
                    <li><a href="{{ route('pegawai.index') }}" aria-expanded="false"><i class="icon icon-globe-2"></i><span
                                class="nav-text">Pegawai</span></a></li>
                </ul>
            </div>
